export async function carregarFooter() {
  fetch("footer.html")
    ...
    .then(async (data) => {
      ...
      inicializarBotoesFooter();
    });
}

export function inicializarBotoesFooter() {
  // Get the modal
  var modal = document.getElementById("modal");

  //Botão - "Sobre Nós"
  var aboutBtn = document.getElementById("aboutButton");
  aboutBtn.addEventListener("click", exibirSobreNos);
  //Botão - "Termos de Privacidade"

  var privacyBtn = document.getElementById("privacyButton");
  privacyBtn.addEventListener("click", exibirPoliticaPrivacidade);
...
export function exibirSobreNos() {
...
export function exibirPoliticaPrivacidade() {
  var aboutHeader = document.getElementById("modal-header");
  var line1 = document.getElementById("phrase1");
